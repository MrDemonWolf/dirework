...
export const themePresets: ThemePreset[] = [
  ...
  // ─── 2. Liquid Glass Light (macOS Tahoe) ────────────────────────────
  {
    ...
    taskStyles: tasks({
      ...
      task: { background: { color: "#ffffff", opacity: 0.65 }, border: { color: "#d1d1d6", width: "1px", radius: "12px" }, fontSize: "22px", fontColor: "#000000", usernameColor: "#007aff", padding: "10px 14px", marginBottom: "4px", maxWidth: "100%", direction: "row" },
  ...
  // ─── 3. Liquid Glass Dark (macOS Tahoe) ────────────────────────────
  {
    ...
    taskStyles: tasks({
      ...
      task: { background: { color: "#3a3a3c", opacity: 0.6 }, border: { color: "#48484a", width: "1px", radius: "12px" }, fontSize: "22px", fontColor: "#f5f5f7", usernameColor: "#0a84ff", padding: "10px 14px", marginBottom: "4px", maxWidth: "100%", direction: "row" },
  ...
  // ─── 4. Neon Cyberpunk ──────────────────────────────────────────────
  {
    ...
    taskStyles: tasks({
      ...
      task: { background: { color: "#1a0a3e", opacity: 0.9 }, border: { color: "#00ff9f", width: "1px", radius: "2px" }, fontSize: "22px", fontColor: "#d0ffd0", usernameColor: "#ff006e", padding: "10px 14px", marginBottom: "4px", maxWidth: "100%", direction: "row" },
  ...
  // ─── 5. Cozy Cottage ────────────────────────────────────────────────
  {
    ...
    taskStyles: tasks({
      ...
      task: { background: { color: "#fff8ee", opacity: 0.95 }, border: { color: "#e8d8c0", width: "1px", radius: "10px" }, fontSize: "22px", fontColor: "#5c3d1a", usernameColor: "#b8860b", padding: "10px 14px", marginBottom: "4px", maxWidth: "100%", direction: "row" },
  ...
  // ─── 6. Ocean Depths ────────────────────────────────────────────────
  {
    ...
    taskStyles: tasks({
      ...
      task: { background: { color: "#0e2240", opacity: 0.9 }, border: { color: "#1a3a5f", width: "1px", radius: "10px" }, fontSize: "22px", fontColor: "#e0f2fe", usernameColor: "#2dd4bf", padding: "10px 14px", marginBottom: "4px", maxWidth: "100%", direction: "row" },
  ...
  // ─── 7. Sakura ──────────────────────────────────────────────────────
  {
    ...
    taskStyles: tasks({
      ...
      task: { background: { color: "#ffffff", opacity: 0.9 }, border: { color: "#fce7f3", width: "1px", radius: "12px" }, fontSize: "22px", fontColor: "#4a1030", usernameColor: "#ec4899", padding: "10px 14px", marginBottom: "4px", maxWidth: "100%", direction: "row" },
  ...
  // ─── 8. Retro Terminal ──────────────────────────────────────────────
  {
    ...
    taskStyles: tasks({
      ...
      task: { background: { color: "#0a1a0a", opacity: 0.9 }, border: { color: "#1a3a1a", width: "1px", radius: "0px" }, fontSize: "22px", fontColor: "#33ff33", usernameColor: "#66ff66", padding: "10px 14px", marginBottom: "4px", maxWidth: "100%", direction: "row" },
  ...
  // ─── 9. Minimal Light ───────────────────────────────────────────────
  {
    ...
    taskStyles: tasks({
      ...
      task: { background: { color: "#f9fafb", opacity: 0.98 }, border: { color: "#e5e7eb", width: "1px", radius: "8px" }, fontSize: "22px", fontColor: "#111827", usernameColor: "#6366f1", padding: "10px 14px", marginBottom: "4px", maxWidth: "100%", direction: "row" },
  ...
  // ─── 10. Sunset ─────────────────────────────────────────────────────
  {
    ...
    taskStyles: tasks({
      ...
      task: { background: { color: "#2d1050", opacity: 0.88 }, border: { color: "#3d1870", width: "1px", radius: "10px" }, fontSize: "22px", fontColor: "#fef3c7", usernameColor: "#ff6b35", padding: "10px 14px", marginBottom: "4px", maxWidth: "100%", direction: "row" },
  ...
  // ─── 11. Twitch Purple ──────────────────────────────────────────────
  {
    ...
    taskStyles: tasks({
      ...
      task: { background: { color: "#18181b", opacity: 0.95 }, border: { color: "#26262c", width: "1px", radius: "10px" }, fontSize: "22px", fontColor: "#efeff1", usernameColor: "#bf94ff", padding: "10px 14px", marginBottom: "4px", maxWidth: "100%", direction: "row" },
