...
function tasks(
  overrides: Partial<TaskStylesConfig> & {
    [K in keyof TaskStylesConfig]?: Partial<TaskStylesConfig[K]>;
  },
): TaskStylesConfig {
...
export const themePresets: ThemePreset[] = [
  ...
  // ─── 2. Ocean Depths (calm navy + teal) ─────────────────────────────
  {
    ...
    taskStyles: tasks({
      header: {
        height: "52px",
        background: { color: "#0c1e3a", opacity: 0.95 },
        border: { color: "#2dd4bf", width: "1px", radius: "12px 12px 0 0" },
        fontSize: "24px",
        fontColor: "#e0f2fe",
        padding: "12px 16px",
      },
      body: {
        background: { color: "#0a1628", opacity: 0.85 },
        border: { color: "#163050", width: "1px", radius: "0 0 12px 12px" },
        padding: { vertical: "6px", horizontal: "6px" },
      },
      task: {
        background: { color: "#0e2240", opacity: 0.9 },
        border: { color: "#1a3a5f", width: "1px", radius: "10px" },
        fontSize: "22px",
        fontColor: "#e0f2fe",
      ...
      checkbox: {
        size: "20px",
        background: { color: "#000000", opacity: 0 },
        border: { color: "#2dd4bf", width: "2px", radius: "6px" },
        margin: { top: "4px", left: "2px", right: "8px" },
        tickChar: "✔",
        tickSize: "14px",
        tickColor: "#2dd4bf",
  ...
  // ─── 3. Liquid Glass Dark (macOS Tahoe) ─────────────────────────────
  {
    ...
    taskStyles: tasks({
      ...
      header: {
        height: "52px",
        background: { color: "#2c2c2e", opacity: 0.82 },
        border: { color: "#48484a", width: "1px", radius: "16px 16px 0 0" },
        fontSize: "24px",
        fontColor: "#f5f5f7",
        padding: "12px 16px",
      },
      body: {
        background: { color: "#1c1c1e", opacity: 0.72 },
        border: { color: "#48484a", width: "1px", radius: "0 0 16px 16px" },
        padding: { vertical: "6px", horizontal: "6px" },
      },
      task: {
        background: { color: "#3a3a3c", opacity: 0.6 },
        border: { color: "#48484a", width: "1px", radius: "12px" },
        fontSize: "22px",
        fontColor: "#f5f5f7",
        usernameColor: "#0a84ff",
        padding: "10px 14px",
        marginBottom: "4px",
        maxWidth: "100%",
      },
      ...
      checkbox: {
        size: "20px",
        background: { color: "#3a3a3c", opacity: 0.4 },
        border: { color: "#636366", width: "1.5px", radius: "6px" },
        margin: { top: "4px", left: "2px", right: "8px" },
        tickChar: "✔",
        tickSize: "14px",
        tickColor: "#0a84ff",
  ...
  // ─── 4. Cozy Cottage (warm cream + gold) ────────────────────────────
  {
    ...
    taskStyles: tasks({
      ...
      header: {
        height: "52px",
        background: { color: "#b8860b", opacity: 0.9 },
        border: { color: "#d4a843", width: "0px", radius: "14px 14px 0 0" },
        fontSize: "24px",
        fontColor: "#fef9f0",
        padding: "12px 16px",
      },
      body: {
        background: { color: "#faf3e8", opacity: 0.88 },
        border: { color: "#e0d0b8", width: "0px", radius: "0 0 14px 14px" },
        padding: { vertical: "6px", horizontal: "6px" },
      },
      task: {
        background: { color: "#fff8ee", opacity: 0.95 },
        border: { color: "#e8d8c0", width: "1px", radius: "10px" },
        fontSize: "22px",
        fontColor: "#5c3d1a",
        usernameColor: "#b8860b",
        padding: "10px 14px",
        marginBottom: "4px",
        maxWidth: "100%",
      },
      ...
      checkbox: {
        ...
        border: { color: "#d4a843", width: "2px", radius: "6px" },
        margin: { top: "4px", left: "2px", right: "8px" },
        tickChar: "✔",
        tickSize: "14px",
        tickColor: "#b8860b",
  ...
  // ─── 5. Minimal Light (clean white) ─────────────────────────────────
  {
    ...
    taskStyles: tasks({
      header: {
        ...
        border: { color: "#e5e7eb", width: "1px", radius: "10px 10px 0 0" },
        fontSize: "24px",
        fontColor: "#111827",
        padding: "12px 16px",
      },
      body: {
        background: { color: "#ffffff", opacity: 0.96 },
        border: { color: "#e5e7eb", width: "1px", radius: "0 0 10px 10px" },
        padding: { vertical: "6px", horizontal: "6px" },
      },
      task: {
        background: { color: "#f9fafb", opacity: 0.98 },
      ...
      checkbox: {
        ...
        border: { color: "#d1d5db", width: "2px", radius: "6px" },
        margin: { top: "4px", left: "2px", right: "8px" },
        tickChar: "✔",
        tickSize: "14px",
        tickColor: "#6366f1",
  ...
  // ─── 6. Twitch Purple (brand) ───────────────────────────────────────
  {
    ...
    taskStyles: tasks({
      header: {
        ...
        border: { color: "#bf94ff", width: "0px", radius: "12px 12px 0 0" },
        fontSize: "24px",
        fontColor: "#ffffff",
        padding: "12px 16px",
      },
      body: {
        background: { color: "#0e0e10", opacity: 0.9 },
        border: { color: "#1f1f23", width: "1px", radius: "0 0 12px 12px" },
        padding: { vertical: "6px", horizontal: "6px" },
      },
      task: {
        background: { color: "#18181b", opacity: 0.95 },
        border: { color: "#26262c", width: "1px", radius: "10px" },
        fontSize: "22px",
        fontColor: "#efeff1",
      ...
      checkbox: {
        size: "20px",
        background: { color: "#000000", opacity: 0 },
        border: { color: "#9146ff", width: "2px", radius: "6px" },
        margin: { top: "4px", left: "2px", right: "8px" },
        tickChar: "✔",
        tickSize: "14px",
        tickColor: "#9146ff",
