...
| `ALCHEMY_STATE_TOKEN` | any long random string (`openssl rand -base64 32`) — authenticates Dirework's dedicated `alchemy-state-dirework` CI state store. Required for GitHub Actions deploys. |
