...
- **Runs in your browser** — The bot lives in a token-gated browser page you add to OBS (or keep in a pinned tab); no always-on bot server to run
...
- **Fast updates** — Overlays pick up changes within a couple of seconds, and the timer countdown ticks smoothly on the overlay itself
