...
| Message | Default | Variables |
| --- | --- | --- |
| Work Started | `Time to hunt! Focus mode activated!` | none |
...
| Focus reminder | `Get ready to howl, @{channel} — focus starts in a moment!` | `{channel}` |
| Not Running | `The timer isn't howling yet! Start it up first.` | none |
| Stream Starting | `The pack is waking up! Stream starting!` | none |
