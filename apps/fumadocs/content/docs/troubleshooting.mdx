...
- **Wrong DATABASE_URL:** Make sure `DATABASE_URL` in your `.env` matches your PostgreSQL connection string. The default is `postgresql://postgres:password@localhost:5432/dirework`.
