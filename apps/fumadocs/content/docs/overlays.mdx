...
| **Labels** | Custom text for each of the seven phases — Idle, Starting, Work, Break, Long Break, Paused, Finished. Defaults are wolf-themed: "Resting", "Gathering the Pack", "On the Hunt", "Den Rest", "Pack Slumber", "Paws'd", "Hunt Complete". |
