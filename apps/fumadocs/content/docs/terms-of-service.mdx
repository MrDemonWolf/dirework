...
- Dirework is a single-user application: the first Twitch account to sign in claims the instance and becomes its only user. There is no multi-user mode.
...
- Securing access to your instance (Dirework is single-owner — the first account to sign in claims it).
